...
AS_IF([test "x$AR" = "xfalse"], [AC_ERROR("Cannot find required command ‘ar’")])
AS_IF([test "x$AS" = "xfalse"], [AC_ERROR("Cannot find required command ‘as’")])
AS_IF([test "x$MV" = "xfalse"], [AC_ERROR("Cannot find required command ‘mv’")])
AS_IF([test "x$RM" = "xfalse"], [AC_ERROR("Cannot find required command ‘rm’")])
AS_IF([test "x$LD" = "xfalse"], [AC_ERROR("Cannot find required command ‘ld’")])
AS_IF([test "x$CP" = "xfalse"], [AC_ERROR("Cannot find required command ‘cp’")])
AS_IF([test "x$GENCAT" = "xfalse"], [AC_ERROR("Cannot find required command ‘gencat’")])
