 ...
 * Deallocate packets.
 *
 * @param[in]     a_pktlist  list of packets to be freed
 * @param[inout]  a_npkts    number of packets
 *
 * @return none.
 */
static void
sockproxy_pkts_free(struct afs_pkt_hdr **a_pktlist, int a_npkts)
{
    int pkt_i;
 ...
 * @param[out]  a_pktlist  packets to be copied to user-space
 * @param[in]   a_npkts    number of packets to be copied
 *
 * @return 0 on success; non-zero otherwise.
 */
