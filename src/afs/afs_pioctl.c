...
static pioctlFunction VpioctlSw[] = {
    ...
    PGetLiteralFID,		/* 70 - get link ID (symlink and mtpt) */
};
...
/*!
 * VIOC_GETLITERALFID (70) - Get FID from parent directory.
 *
 * Instead of getting the FID directly from the vcache associated with 'ain'
 * (like PGetFID), get this information looking up this entry in the parent
 * directory.
 *
 * \ingroup pioctl
 *
