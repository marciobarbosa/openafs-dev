...
/* hostparse.c */
typedef char host_name_t[256];
extern struct hostent *hostutil_GetHostByName(char *ahost);
extern char *hostutil_GetNameByINet(afs_uint32 addr);
extern void *hostutil_CreateHostCacheCtx(void);
extern void hostutil_RemoveHostCacheCtx(void *ctxp);
extern char *hostutil_GetNameByINetCache(void *ctxp, afs_uint32 addrp, host_name_t namep);
