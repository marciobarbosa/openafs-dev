...
#define AFSDIR_RXGK_KEYTAB_FILE "rxgk.keytab"
...
typedef enum afsdir_id {
    ...
    AFSDIR_SERVER_RXGK_KEYTAB_FILEPATH_ID,
...
#define AFSDIR_SERVER_RXGK_KEYTAB_FILEPATH afs_getDirPath(AFSDIR_SERVER_RXGK_KEYTAB_FILEPATH_ID)
