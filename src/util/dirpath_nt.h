...
#define AFSDIR_DASALVAGER_FILE  "dasalvager"
...
#define AFSDIR_CANONICAL_SERVER_DASALVAGER_FILEPATH \
AFSDIR_CANONICAL_SERVER_BIN_DIRPATH "/" AFSDIR_DASALVAGER_FILE
...
typedef enum afsdir_id {
    ...
    AFSDIR_SERVER_DASALVAGER_FILEPATH_ID,
...
#define AFSDIR_SERVER_DASALVAGER_FILEPATH afs_getDirPath(AFSDIR_SERVER_DASALVAGER_FILEPATH_ID)
