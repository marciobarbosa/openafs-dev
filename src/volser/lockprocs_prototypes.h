...
extern void Lp_SetRWValue(struct nvldbentry *entry, afs_in_addr oserver, afs_int32 opart,
              afs_in_addr nserver, afs_int32 npart);
extern void Lp_SetROValue(struct nvldbentry *entry, afs_in_addr oserver,
              afs_int32 opart, afs_in_addr nserver, afs_int32 npart);
extern int Lp_Match(afs_in_addr server, afs_int32 part, struct nvldbentry *entry);
extern int Lp_ROMatch(afs_in_addr server, afs_int32 part, struct nvldbentry *entry);
