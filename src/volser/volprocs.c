	       ...
	       struct restoreCookie *cookie)
{
	...
	Log("1 Volser: VolForward: volume %s (%u) appears to have been "
	    ...
	    "(updateDate of at least one read-only copy is moving backwards "
	    "from %u to %u). This is allowed, but may indicate a mistake in "
	    "whatever tool is releasing this volume. If this volume appears "
	    "corrupted, this is probably why. In an effort to mitigate the "
	    "possible undesirable side effects of this operation, force a full "
