...
extern pthread_mutex_t vol_attachpart_mutex;
...
/*
 * VATTACHPART_LOCK is exclusively used to serialize VolAttachPartitions.
 * This lock must be acquired before VOL_LOCK.
 */
#define VATTACHPART_LOCK opr_mutex_enter(&vol_attachpart_mutex)
#define VATTACHPART_UNLOCK opr_mutex_exit(&vol_attachpart_mutex)
...
#define VATTACHPART_LOCK
#define VATTACHPART_UNLOCK
