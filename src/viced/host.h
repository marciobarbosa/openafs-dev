...
struct host_to_zero {
    ...
    afs_in_addr host;	 	/* IP address of host interface that is
...
extern int h_Lookup_r(afs_in_addr hostaddr, afs_uint16 hport,
		      struct host **hostp);
...
extern void h_flushhostcps(afs_in_addr hostaddr,
			   afs_uint16 hport);
...
extern void h_AddHostToAddrHashTable_r(afs_in_addr addr, afs_uint16 port, struct host * host);
extern void h_AddHostToUuidHashTable_r(afsUUID * uuid, struct host * host);
extern int h_DeleteHostFromAddrHashTable_r(afs_in_addr addr, afs_uint16 port, struct host *host);
extern int h_DeleteHostFromUuidHashTable_r(struct host *host);
extern int addInterfaceAddr_r(struct host *host, afs_in_addr addr, afs_uint16 port);
extern int removeInterfaceAddr_r(struct host *host, afs_in_addr addr, afs_uint16 port);
