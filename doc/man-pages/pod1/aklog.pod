...
B<aklog> [B<-d>] [B<-hosts>] [B<-zsubs>] [B<-noprdb>] [B<-noauth>] [B<-linked>]
    [B<-force>] [B<-nokernelprefs>] [B<-524>] [B<-setpag>]
    S<<< [[B<-cell> | B<-c>] <I<cell>> [B<-k> <I<Kerberos realm>>]]+ >>>

B<aklog> [B<-d>] [B<-hosts>] [B<-zsubs>] [B<-noprdb>] [B<-noauth>] [B<-linked>]
    [B<-force>] [B<-nokernelprefs>] [B<-524>] [B<-setpag>] [B<-path> | B<-p>] <I<path>>+
...
=item B<-nokernelprefs>

Do not use kernel dbserver preferences. Find server via old randomized
mechanism.
