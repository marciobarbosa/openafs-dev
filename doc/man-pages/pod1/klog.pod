...
B<klog> [B<-x>] S<<< [B<-principal> <I<user name>>] >>>
    ...
    [B<-setpag>] [B<-tmp>] [B<-nokernelprefs>] [B<-help>]
...
Makes the client do not use kernel dbserver preferences. As a result,
an authentication server will be chosen randomly.
