...
L<B<pts authnametoid>|pts_authnametoid(1)>,
L<B<pts chown>|pts_chown(1)>,
L<B<pts examine>|pts_examine(1)>,
L<B<pts listauthnames>|pts_listauthnames(1)>,
L<B<pts listentries>|pts_listentries(1)>,
L<B<pts rename>|pts_rename(1)>,
L<B<pts setfields>|pts_setfields(1)>,
and L<B<pts whoami>|pts_whoami(1)>.
...
Commands to examine the ptserver itself:
L<B<pts capabilities>|pts_capabilities(1)>.
