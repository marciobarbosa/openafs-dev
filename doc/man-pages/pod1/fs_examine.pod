...
B<fs exa> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-l>] [B<-h>]

B<fs listvol> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-l>] [B<-h>]

B<fs listv> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-l>] [B<-h>]

B<fs lv> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-l>] [B<-h>]
