...
B<fs examine> S<<< [B<-path> <I<dir/file path>>+] >>> [B<-no-follow>] [B<-help>]

B<fs exa> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-n>] [B<-h>]

B<fs listvol> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-n>] [B<-h>]

B<fs listv> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-n>] [B<-h>]

B<fs lv> S<<< [B<-p> <I<dir/file path>>+] >>> [B<-n>] [B<-h>]
...
Unix only: for a symlink or mount point, evaluates the specified object rather
than the object it refers to.
