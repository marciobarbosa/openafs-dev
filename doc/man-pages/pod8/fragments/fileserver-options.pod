...
If -readonly is also specified, this flag allows write requests for members of
system:administrators on the read-only fileserver in question. If -readonly is
not specified, this flag does nothing.
